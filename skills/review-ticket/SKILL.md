...
In autonomous mode the posted report ends with the fenced handshake from *Verdict → handshake mapping* below, after the full code review report; see *Report posting* under Autonomous mode.
